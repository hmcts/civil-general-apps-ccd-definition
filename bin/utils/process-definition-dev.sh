...
docker run --rm --name json2xlsx \
  ...
  -v ${definition_output_file}:/tmp/general-apps-ccd-definition.xlsx \
  ...
  json2xlsx -D /tmp/ccd-definition -o /tmp/general-apps-ccd-definition.xlsx ${additionalParameters}
