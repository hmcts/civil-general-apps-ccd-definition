...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=https://ccd-definition-store-civil-general-apps-ccd-definition-pr-${pr}.service.core-compute-preview.internal"
...
echo "export CCD_DEF_CASE_SERVICE_BASE_URL=http://civil-general-apps-ccd-definition-pr-${pr}-civil-service"
echo "export CCD_DEF_GEN_APP_SERVICE_BASE_URL=http://civil-general-apps-ccd-definition-pr-${pr}-java"
