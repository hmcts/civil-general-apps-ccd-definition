...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=https://ccd-definition-store-civil-ga-ccd-pr-${pr}.service.core-compute-preview.internal"
echo "export CAMUNDA_BASE_URL=https://camunda-civil-ga-ccd-pr-${pr}.service.core-compute-preview.internal"

# definition placeholders
echo "export CCD_DEF_CASE_SERVICE_BASE_URL=http://civil-ga-ccd-pr-${pr}-civil-service"
echo "export CCD_DEF_GEN_APP_SERVICE_BASE_URL=http://civil-ga-ccd-pr-${pr}-java"
