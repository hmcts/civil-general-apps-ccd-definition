...
Scenario('Spec Claimant create GA with single application type - @galip', async ({ api }) => {
...
Scenario('Spec Claimant create GA with multiple application types - @galip', async ({ api }) => {
  civilCaseReference = await api.createClaimWithUnrepresentedClaimant(config.applicantCitizenUser, 'SmallClaims', false, 'INDIVIDUAL');
