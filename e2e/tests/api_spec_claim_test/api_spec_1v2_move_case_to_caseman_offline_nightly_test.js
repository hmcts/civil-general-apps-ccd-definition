...
Feature('GA SPEC Claim 1v2 Move to Case Man Case Close API tests @api-tests');

Scenario('Case offline APPLICATION_SUBMITTED_AWAITING_JUDICIAL_DECISION @api-tests', async ({api}) => {
