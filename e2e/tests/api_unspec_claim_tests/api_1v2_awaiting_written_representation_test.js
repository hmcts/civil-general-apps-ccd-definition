...
Feature('Karthick GA 1v2 Judge Make Order Written Rep API tests @api-tests2 ');

Scenario.only('Karthick Judge makes decision 1V2 - WRITTEN_REPRESENTATIONS', async ({api}) => {
