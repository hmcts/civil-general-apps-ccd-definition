...
let expectedHDJudgeRecitalText = `<Title> <Name> \nUpon reading the application of Claimant dated ${fullDate} and upon considering the information provided by the parties`;
