...
module.exports = {
  ...
  async selectWrittenRepresentations(representationsType) {
    ...
    switch (representationsType) {
      case 'sequentialRep':
        I.see('The claimant may upload any written responses or evidence in reply by 4pm on');
        I.see('The defendant may upload any written responses or evidence by 4pm on');
        ...
        break;
      case 'concurrentRep':
        I.see('The claimant and defendant may upload any written submissions and evidence by 4pm on');
