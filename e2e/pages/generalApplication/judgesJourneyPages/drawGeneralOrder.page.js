...
module.exports = {
  ...
  async verifyWrittenRepresentationsDrawGeneralOrderScreen(representationsType, notice, orderType) {
    ...
    if ('sequentialRep' === representationsType) {
      await I.see('The defendant may upload any written responses or evidence by 4pm on');
      await I.see('The claimant may upload any written responses or evidence in reply by 4pm on');
    } else {
      await I.see('The claimant and defendant may upload any written submissions and evidence by 4pm on');
    }
